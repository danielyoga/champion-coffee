...
;;     (asserts! (not (unwrap! (get-merchant-status customer-address) (err u107)))
;;       (err u107)
;;     )
...
;;   (ok (ft-get-balance alliance-token user))
;; )

;; (define-read-only (get-total-supply)
;;   (ok (ft-get-supply alliance-token))
;; )

;; UMKM Alliance Token - Minimal Working Version
;; Remove SIP-010 for now to ensure deployment works
